...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
       <h1 class="h3 mb-0 text-gray-800">Gerenciador de remoção</h1>
                                    ...
                                    @foreach ($users as $us)
                                       ...
                                       <div class="row my-4">  
                                          ...
                                          <form class="col" action="{{ url("delete/$us->id")}}">
                                             ...
                                             @csrf
                                             @method('DELETE')
                                             <button type="submit" class=" btn btn-sm btn-light" >Deletar</button>
                                          </form>  
                                       </div>
